...
class AmadeusFlightClient:
    ...
    def __init__(self, api_key: str, api_secret: str):
        ...
        # CRITICAL FIX: Set SSL default context globally
        # The Amadeus SDK doesn't accept an 'ssl' parameter - it uses urllib internally
        # So we must configure the default SSL context before creating the client
        ssl_context = ssl.create_default_context(cafile=certifi.where())
        ssl._create_default_https_context = lambda: ssl_context
        
        print(f"[AmadeusClient] 🔒 SSL configured with certifi bundle: {certifi.where()}")
...
EOFcat > /Users/Miranda/Projects/AI_vacation_planner/backend/mcp-servers/flights/amadeus_client.py << 'EOF'
"""
Amadeus API Client with SSL Configuration
==========================================
Handles all communication with the Amadeus Flight API.
